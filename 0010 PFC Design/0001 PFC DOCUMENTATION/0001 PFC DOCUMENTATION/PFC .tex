...
\end{figure}
%-------------------------------------------------------
Designing an AC EMI (Electromagnetic Interference) filter for an onboard charger involves several stages to reduce conducted and radiated emissions.  
%-------------------------------------------------------
...
Purpose:
Suppress high-frequency conducted emissions.
Components:
Input capacitors
Dimensioning:
Capacitance value: Choose to filter out high-frequency noise and stabilize the input voltage.
